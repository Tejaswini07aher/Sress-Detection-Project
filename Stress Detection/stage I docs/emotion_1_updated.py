...
def files_count():
    ...
    if int(number_of_Happy_files) > int(number_of_Fear_files) and int(number_of_Happy_files) > int(number_of_sad_files) and int(number_of_Happy_files) > int(number_of_neutral_files) and int(number_of_Happy_files) > int(number_of_Surprised_files) :
        str_label="Person Was Happy(Stress Evalution 0%)"
        print(str_label)
        TTS = gTTS(str_label)
        TTS.save('audio.mp3')
        os.system('audio.mp3')
        ...
        str_label = " Person Was Fearful(Stress Evalution 100%) "
        print(str_label)
        TTS = gTTS(str_label)
        TTS.save('audio.mp3')
        os.system('audio.mp3')
        ...
        str_label = " Person Was Neutral(Stress Evalution 25%) "
        print(str_label)
        TTS = gTTS(str_label)
        TTS.save('audio.mp3')
        os.system('audio.mp3')
        ...
        str_label = " Person Was Sad(Stress Evalution 80%) "
        print("Person Was Sad(Stress Evalution 80%)")
        TTS = gTTS(str_label)
        TTS.save('audio.mp3')
        os.system('audio.mp3')
        ...
        str_label = " Person Was Surprised(Stress Evalution 5%)"
        print(str_label)
        TTS = gTTS(str_label)
        TTS.save('audio.mp3')
        os.system('audio.mp3')
